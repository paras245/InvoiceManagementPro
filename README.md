...
This project is my **first creation in web development**, built using **HTML, CSS, JavaScript, Jquery, Bootstrap, .NET MVC architecture** with a **Code First approach**.
It’s a **basic billing application** designed to understand real-world CRUD flows and UI interactions.
...
**Paras Panchal**
Web Developer | Learning .NET & Modern Web Development
